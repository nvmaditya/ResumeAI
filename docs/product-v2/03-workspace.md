...
Per-resume IDE: identity, grouped actions, left rail, editor, PDF, floating coach.
...
| Coach proposals + source | In-editor diff strip |
...
4. Coach floats; score not auto after edits.
