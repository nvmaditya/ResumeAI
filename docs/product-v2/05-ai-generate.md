...
- Title.  
- Internal generation skill guidance + optional LLM via coach backend (ollama / openrouter / groq).  
...
| Edit in form then generate | Edit LaTeX; coach; **no** re-generate on this resume |
...
5. Live coach backend must be able to drive generate in real installs.
