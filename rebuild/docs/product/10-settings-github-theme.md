...
`GET /api/v1/health` → status, env, score_backend, latex_engine.
...
- [x] Score does not require live GitHub  
- [x] Theme toggle + reduced-motion wipe  
- [x] Toasts for save username / GitHub update / score timeout / version unchanged
